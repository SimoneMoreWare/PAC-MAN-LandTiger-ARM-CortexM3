...
#define UPTICKS				1
    ...
    #define SPEEDUP        1.5f    // Increase the speed to adjust timing for simulation
    #define AMPLIFIER      2.5       // Amplify the sound for better simulation
		#define VOLUME 8
#else
...
typedef enum note_durations
{
	...
	time_6th 			= (unsigned int)(SECOND * SPEEDUP / 6.0f + 0.5),  	  // 1/6 (duration fo a 1/6 note)
...
extern unsigned short currentNote;
